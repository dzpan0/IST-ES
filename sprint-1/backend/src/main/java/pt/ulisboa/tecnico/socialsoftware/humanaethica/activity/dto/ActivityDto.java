...
public class ActivityDto {
    ...
    public ActivityDto(Activity activity, boolean deepCopyInstitution){
        ...
        this.shifts = activity.getShifts().stream()
                .map(shift-> new ShiftDto(shift, true))
                .toList();
    ...
    public Integer getNumberOfParticipations() {
        ...
        return shifts.stream().mapToInt(shift -> shift.getParticipations().size()).sum();
    }
    ...
    public Integer getNumberOfEnrollments() {
        ...
        return shifts.stream().mapToInt(shift -> shift.getEnrollments().size()).sum();
    }
    ...
    public String toString() {
        return "ActivityDto{" +
                ...
                ", numberOfParticipations=" + getNumberOfParticipations() +
