...
public enum ErrorMessage {
    ...
    ENROLLMENT_NO_SHIFTS("Enrollment has no shifts associated"),
    ...
    ENROLLMENT_SHIFTS_DONT_MATCH("The shifts in the enrollment are from different activties"),
    ENROLLMENT_SHIFTS_OVERLAP("The shifts in the enrollment overlap with each other"),
    ...
    PARTICIPATION_SHIFT_NOT_IN_ENROLLMENT("Participation enrollment must contain the participation's shift"),
    ...
    // Shift
    SHIFT_INVALID("Shift is not valid"),
    SHIFT_NOT_FOUND("Shift not found with id %d"),
    SHIFT_MISSING_START("Shift starting date is empty or null"),
    SHIFT_MISSING_END("Shift ending date is empty or null"),
    SHIFT_MISSING_LIMIT("Shift limit is empty or null"),
    SHIFT_MISSING_LOCATION("Shift location is empty or null"),
    SHIFT_MISSING_ACTIVITY("Shift activity is empty or null"),
    SHIFT_STRING_LENGTH("String attribute in shift has invalid length"),
    SHIFT_START_AFTER_END("Shift start is after end"),
    SHIFT_NOT_WITHIN_ACTIVITY_PERIOD("Shift is not within activity dates"),
    SHIFT_INVALID_LIMIT("Shift participant limit is invalid"),
    ACTIVITY_NOT_APPROVED("Activity %s is not approved"),
    SHIFT_CAPACITY_GREATER_THAN_ACTIVITY("Shift participant limit is greater than the associated activity's participant limit"),
    ;
