...
class GetEnrollmentsByActivityServiceTest extends SpockTest {
    ...
    def setup() {
        ...
        shift = createShift(activity, SHIFT_LIMIT_1, IN_TWO_DAYS.plusHours(1), IN_THREE_DAYS.minusHours(1), SHIFT_LOCATION_1)
    ...
    def "get one enrollment of an activity"() {
        given: "volunteer info"
        def volunteer = createVolunteer(USER_1_NAME, USER_1_USERNAME, USER_1_EMAIL, AuthUser.Type.NORMAL, User.State.APPROVED)

        and: "shift info"
        def otherShift = createShift(otherActivity, SHIFT_LIMIT_1, IN_TWO_DAYS.plusHours(1), IN_THREE_DAYS.minusHours(1), SHIFT_LOCATION_1)
