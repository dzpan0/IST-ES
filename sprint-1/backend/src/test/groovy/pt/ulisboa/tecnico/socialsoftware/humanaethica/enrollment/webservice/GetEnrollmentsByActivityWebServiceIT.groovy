...
class GetEnrollmentsByActivityWebServiceIT extends SpockTest {
    ...
    def setup() {
        ...
        and: "setup activity"
        def activityDto = createActivityDto(ACTIVITY_NAME_1,ACTIVITY_REGION_1,ACTIVITY_LIMIT_1,ACTIVITY_DESCRIPTION_1,IN_ONE_DAY, IN_TWO_DAYS,IN_THREE_DAYS,null)
        ...
        def otherShift = createShift(activity, SHIFT_LIMIT_1, IN_TWO_DAYS.plusHours(1), IN_THREE_DAYS.minusHours(1), SHIFT_LOCATION_2)

        and: "setup volunteers"
        ...
        and: "setup enrollments"
        createEnrollment(volunteerOne, [shift], ENROLLMENT_MOTIVATION_1)
        createEnrollment(volunteerTwo, [otherShift], ENROLLMENT_MOTIVATION_2)
    }
