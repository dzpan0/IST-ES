...
class SpockTest extends Specification {
    ...
    public static final Integer ACTIVITY_LIMIT_1 = 5;
    public static final Integer ACTIVITY_ID_1 = 1;
    public static final Integer ACTIVITY_ID_2 = 2;
    ...
    public static final String SHIFT_LOCATION_1 = "somewhere on campus, building A, room 101";
    public static final String SHIFT_LOCATION_2 = "somewhere on campus, building A, room 102";
    public static final Integer SHIFT_LIMIT_1 = 1;
    public static final Integer SHIFT_LIMIT_2 = 2;
    public static final Integer SHIFT_LIMIT_3 = 3;
    public static final Integer SHIFT_ID_1 = 1;
    public static final Integer SHIFT_ID_2 = 2;
    ...
    def createShift(activity, limit, start, end, location) {
        def shiftDto = new ShiftDto()
        shiftDto.setParticipantsNumberLimit(limit)
        shiftDto.setStartingDate(DateHandler.toISOString(start))
        shiftDto.setEndingDate(DateHandler.toISOString(end))
    ...
    def createParticipation(volunteer, enrollment, shift, participationDto ) {
        participationDto.enrollmentId = enrollment.getId()
        participationDto.shiftId = shift.getId()
    ...
    def deleteAll() {
        ...
        enrollmentRepository.deleteAllEnrollmentShift()
